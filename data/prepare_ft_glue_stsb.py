...
data = load_dataset('glue',name=TASK[1:],revision='b4b3e3965b74b673e8a6528d1bc059d7a77b53ff')
...
for i in tqdm(range(len(train_1))):
    temp.append([1] + train_1[i] + [2] + [1] + train_2[i] + [2])
...
train_mask = torch.tensor(train_mask).view(-1,1)
