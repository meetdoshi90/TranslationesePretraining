...
TASK = 'ai4bharat/IndicQuestionGeneration'
LANG = 'hi'
CONTEXT_LEN = 1024
...
for row in data['train']:
    #print(row)
    train.append('प्रसंग: '+ row['context'] + ' उत्तर: ' + row['answer'] + ' सवाल: ')
    train_mask.append(row['question'])
    #break
...
for row in data['validation']:
    #print(row)
    train.append('સંદર્ભ: '+ row['context'] + ' જવાબ: ' + row['answer'] + ' પ્રશ્ન: ')
    train_mask.append(row['question'])
    #break
