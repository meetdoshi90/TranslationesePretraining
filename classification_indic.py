...
TRAIN_DATAPATH = f'/raid/nlp/pranavg/meet/IndicLLM/IndicGPT/data/train-data-ft-hi-{TASK_NAME}/train.pt'
VAL_DATAPATH = f'/raid/nlp/pranavg/meet/IndicLLM/IndicGPT/data/val-data-ft-hi-{TASK_NAME}/val.pt'
